...
public class ProjectTestSetRootCategory implements ICustomProjectElement, ICategoryProjectElement {

	private Image _image;
	private List<ICustomProjectElement>_childs;
	public static final String NAME = "Тестовые наборы";
	private CustomProjectParent _parent;

	public ProjectTestSetRootCategory(CustomProjectParent customProjectParent) {
	...
	public Image getImage() {
        if (_image == null) {
            _image = Activator.getImage("images/testset.png"); //$NON-NLS-1$
        }
