...
public class ProjectComponentRootCategory implements ICustomProjectElement, ICategoryProjectElement {
	...
	public ProjectComponentRootCategory(CustomProjectParent customProjectParent) {
	...
	public Object[] getChildren() {
		...
		if (_childs == null) {
			_childs = service.loadComponents(0);
		}
