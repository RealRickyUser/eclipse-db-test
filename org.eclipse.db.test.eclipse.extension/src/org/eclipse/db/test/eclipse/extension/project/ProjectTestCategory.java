...
public class ProjectTestCategory extends ItemCategory<TestCategory> implements ICategoryProjectElement {
	private List<ICustomProjectElement>_childs;
	
	public ProjectTestCategory(TestCategory item) {
		super(item);
	}
	...
	public Object[] getChildren() {
		if (_childs == null) {
			...
			_childs = service.loadTests(_item.getId());
		}
