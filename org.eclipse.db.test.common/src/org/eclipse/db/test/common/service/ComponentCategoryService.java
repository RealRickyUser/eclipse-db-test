...
public class ComponentCategoryService {
	...
	public static List<Integer> getAllCategories(DbServerInfo info, int rootId) {
		...
		try {
			...
			NamedParameterStatement stmt = new NamedParameterStatement(conn, "exec GetComponentCategories :id");
	...
	public static void updateCategory(DbServerInfo info, ComponentCategory category) {
		Connection conn = ConnectionManager.getConnection(info);
		String query = "UPDATE ComponentCategory SET name = :name WHERE id = :id";
		try {
	...
	public static void deleteCategory(DbServerInfo info, int categoryId) {
		Connection conn = ConnectionManager.getConnection(info);
		String query = "DELETE FROM ComponentCategory WHERE id = :id";
		try {
			NamedParameterStatement stmt = new NamedParameterStatement(conn, query);
